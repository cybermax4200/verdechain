...
const FUEL_FACTORS: FactorCategory = {
  ...
  biomass: { value: 0.0972, unit: 'kgCO2e/kWh', source: 'IPCC 2024', year: 2024 },
  jet_fuel: { value: 0.2592, unit: 'kgCO2e/kWh', source: 'IPCC 2024', year: 2024 },
...
const INDUSTRIAL_FACTORS: FactorCategory = {
  ...
  steel_bof: { value: 2.33, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  steel_eaf: { value: 0.68, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  aluminum_smelting: { value: 1.67, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  ammonia: { value: 1.618, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  hydrogen_smr: { value: 9.3, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  hydrogen_electrolysis: { value: 0.5, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  glass_manufacturing: { value: 0.56, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  lime_production: { value: 0.75, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
  nitric_acid: { value: 3.0, unit: 'kgCO2e/kg', source: 'IPCC 2024', year: 2024 },
};
...
const TRANSPORT_FACTORS: FactorCategory = {
  ...
  maritime_container: { value: 0.01, unit: 'kgCO2e/tkm', source: 'IPCC 2024', year: 2024 },
  maritime_bulk: { value: 0.008, unit: 'kgCO2e/tkm', source: 'IPCC 2024', year: 2024 },
  air_freight_short: { value: 1.17, unit: 'kgCO2e/tkm', source: 'IPCC 2024', year: 2024 },
  air_freight_long: { value: 0.57, unit: 'kgCO2e/tkm', source: 'IPCC 2024', year: 2024 },
